...
async def primary_handler(callback: CallbackQuery, button, dialog_manager: DialogManager):
    dialog_manager.dialog_data["category"] = "Primary"
    await dialog_manager.next()


async def secondary_handler(callback: CallbackQuery, button, dialog_manager: DialogManager):
